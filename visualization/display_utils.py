    ...
    if not isinstance(images, list):  # single image
        ...
        if isinstance(segs, list) and len(segs) == 0:
            ...
            display_image(image, window_min=intensity_window[0], window_max=intensity_window[1],
                          slice_number=slice_number, title=title, show=show, pfile=pfile, figsize=figsize)
        else:
...
def display_image(image, slice_number=-1, window_min=0, window_max=255, title=None, show=True, pfile=None, figsize=None):
    """
...
#             # a[0, n].imshow(sitk.GetArrayViewFromImage(img_X), cmap='gray')
#             # if maps[n] is not None:
#             #     a[0, n].imshow(sitk.GetArrayViewFromImage(map_X), cmap=mycmap, alpha=0.7)
#             # a[0, n].axis('off')
#             # if title is not None:
#             #     if title[n] is not None:
#             #         a[0, n].set_title(title[n])
...
#             # a[1, n].imshow(sitk.GetArrayViewFromImage(img_Y), cmap='gray')
#             # if maps[n] is not None:
#             #     a[1, n].imshow(sitk.GetArrayViewFromImage(map_Y), cmap=mycmap, alpha=0.7)
#             # a[1, n].axis('off')
#             # # a[1, n].set_title('Y')
#             # plt.draw()
#             # a[2, n].clear()
#             # a[2, n].imshow(sitk.GetArrayViewFromImage(img_Z), cmap='gray')
#             # if maps[n] is not None:
#             #     a[2, n].imshow(sitk.GetArrayViewFromImage(map_Z), cmap=mycmap, alpha=0.7)
#             # a[2, n].axis('off')
#             # # a[2, n].set_title('Z')
#             # plt.draw()
#             # plt.draw()
